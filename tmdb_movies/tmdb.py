...
class TMDBMovieScraper(object):
    ...
    def _assemble_details(self, movie, movie_fallback, collection, collection_fallback):
        info = {
            ...
            'credits': _get_cast_members(movie.get('casts', []), 'crew', 'Writing', ['Screenplay', 'Writer', 'Author']),
            'director': _get_cast_members(movie.get('casts', []), 'crew', 'Directing', ['Director']),
        ...
        cast = [{
            ...
            for actor in movie.get('casts', {}).get('cast', [])
        ]
